...
<head id="Head1">
    ...
    <title>欢迎登陆系统</title>
    <link href="../Data/css/login.css" rel="stylesheet" type="text/css" rev="stylesheet" media="all"  />
    <link href="../Data/css/demo.css" rel="stylesheet" type="text/css" rev="stylesheet" media="all" />
            ...
            <div id="o-box-down" style="table-layout: fixed;">
                ...
                <div class="fm-item">
                    <label for="logonId" class="form-label">
                        用户名：</label>
                    <input class="easyui-textbox" style="width:60%;height:30px;padding:12px" data-options="prompt:'输入用户名',iconCls:'icon-man',iconWidth:38" type="text" id="txtUserID" tabindex="1" />
                ...
                <div class="fm-item">
                    <label for="logonId" class="form-label">
                        密&nbsp;&nbsp;码：</label>
                    <input class="easyui-textbox" style="width:60%;height:30px;padding:12px" data-options="prompt:'输入密码',iconCls:'icon-lock',iconWidth:38"  type="password" id="txtPassword" tabindex="2" />
                    <div class="ui-form-explain">
                    </div>
                </div>
                ...
                <div id="lblRegMsg" style="color: Red"></div>
                <div class="fm-item btn" >
                    <label for="logonId" class="form-label">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </label><%--<div style="width:30px;display:inline-block"></div>--%>
                    <a href="#" id="btnSubmit" class="easyui-linkbutton"  onclick="checkLogin()" style="padding:1px 0px;width:25%; height:95%; text-align:center;">
                    <span style="font-size:10pt;">登&nbsp;&nbsp;录</span>
                    </a>
                    <div class="ui-form-explain">
                    </div>
                </div>
